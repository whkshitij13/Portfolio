...
export default function ExperienceCard({}: Props) {
  return (
   <article className='flex flex-col rounded-lg items-center  flex-shrink-0 w-[500px] md:w-[600px] xl:w-[700px] snap-center bg-green-500/10 p-10 hover:opacity-100
